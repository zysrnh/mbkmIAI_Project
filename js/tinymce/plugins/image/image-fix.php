...
error_reporting(0);
require_once('../../../../ikutan/session.php');


if ($_SESSION['LevelAkses']=="Administrator" || $_SESSION['LevelAkses']=="Guru" || $_SESSION['LevelAkses']=="Operator"){
...
if(!defined('LIBRARY_FOLDER_PATH')){
	define('LIBRARY_FOLDER_PATH', 'js/tinymce/plugin/image/uploads/');
}
        ...
        add: function (e, data) {
           ...
           // Append the file name and file size
            ...
            if(data.result.success == true){
        		data.context.remove();
        		$("#uploaded-images").append('<a style="margin: 9px; margin-right: 27px;" href="" class="img-thumbs" rel="' + data.result.file + '"><img src="uploads/' + data.files[0].name + '" class="img-polaroid" width="130" height="90"></a>');
        	}else{
        		data.context.empty();
