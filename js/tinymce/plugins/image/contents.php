	...
	foreach($current_folder_content as $c){
		if($view == 'list'){
			...
			<div class="clearfix"></div>
				...
				$html .= '<div class="item" style="padding-bottom:20px;margin-bottom:30px;">
		<a href="" class="img-thumbs" rel="js/tinymce/plugins/image/uploads/'. $c['name'] .'" title="'. $c['name'] .'">
			<img src="uploads/'. $c['name'] .'" class="img-polaroid" width="120" height="90"><br/>
			</a>
			<div>
