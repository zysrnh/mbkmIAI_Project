	...
	function showDialog() {
		...
		function GetTheHtml(){
			...
			if(imgElm){
				...
				html += '<iframe src="'+ url + '/image-fix.php'+ query_str + '&' + new Date().getTime() + '" frameborder="0"></iframe>';
			}else{
				...
				html += '<iframe src="'+ url + '/image-fix.php'+ '?' + new Date().getTime() + '" frameborder="0"></iframe>';
			}
