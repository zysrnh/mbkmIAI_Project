...
/*<![CDATA[*/
@import url("modul/calendar/css/calendar.css");
/*]]>*/
</style>';
include 'modul/calendar/calendar_function.php';
...
req.open('get','modul/calendar/calendar_response.php?'+url,true);
...
kotakjudul ('Agenda Terbaru','<span class="boxisimenu">'.$toolstips_cal_EVENT.'</span>');
}
