...
<tr class="caption">
<th style="padding:5px;"><a onclick="requestCalendarUrl(\'sel_date='.$prev_year.'\')" style="text-decoration: none;color:#ffffff" title="Prevous Year">&laquo;</a></th>
...
$cals .= ' <tr>
    <th width="14%" title="Minggu" scope="col" abbr="Sunday"><center>Minggu</center></th>
    <th width="14%" title="Senin" scope="col" abbr="Monday"><center>Senin</center></th>
    <th width="14%" title="Selasa" scope="col" abbr="Tuesday"><center>Selasa</center></th>
    <th width="14%" title="Rabu" scope="col" abbr="Wednesday"><center>Rabu</center></th>
    <th width="14%" title="Kamis" scope="col" abbr="Thursday"><center>Kamis</center></th>
    <th width="14%" title="Jum`at" scope="col" abbr="Friday"><center>Jumat</center></th>
    <th width="14%" title="Sabtu" scope="col" abbr="Saturday"><center>Sabtu</center></th>
    </tr>
  ';  
    ...
    */
    ...
    $cekdate = $koneksi_db->sql_query ("SELECT judul,waktu_mulai,waktu_akhir,isi,background,color FROM `tbl_kalender` WHERE left( `waktu_mulai` , 7 ) = '$varwaktucalender'");
        ...
        if( $t['mon'] == date('n', $i ) ) {
           ...
           if( $i == $sel_date ) {
             ...
             if (in_array((int)date('j', $i),$TGLIN_ARRAY)) {
                 ...
                 $toolstips_cal_EVENT = "\r\n". $TMPpesan__[$valitemselectedday] ."<br /><a href=\"index.php?pilih=calendar&amp;modul=yes&amp;act=calendar_view&amp;action=detail&amp;sel_date=".$sel_date."&amp;waktu_akhir=".$TMPtgl_akhir[$valitemselectedday]."\" style=\"margin-bottom:-60px;\">Selengkapnya</a>\r\n";       
           ...
           if ($TGLMULAI[$valitemselectedday] == date('j', $i)) {
	         ...
	         $links[0] = '<a title="'.$JUDULCAL[date('j', $i)].'" href="index.php?pilih=calendar&amp;modul=yes&amp;act=calendar_view&amp;sel_date='. $i .'" style="text-decoration:none;'.$color.'">';
	         $links[1] = '</a>';
	         
	         $toolstips_cal .= '
                        <div id="calendar_'.$valitemselectedday.'" style="display:none;POSITION: absolute; PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; WIDTH: 80%; PADDING-TOP: 10px; BACKGROUND-COLOR: #efefef;border:1px solid #b1b1b1;font-family:verdana,tahoma,arial;font-size:10px;line-height:13px">
