...
var komentar = {
url:'modul/artikel/ajax/komentar_data.php',
xmlhttp:function(){
var xmlhttp = false;
try {
...
buka:function(obj){
$odb(obj).style.display = ($odb(obj).style.display == 'none') ? 'inline' : 'none';	
},
...
boxloading('Loading');
$odb('respon').innerHTML = '<span style="padding: 10px;">Tidak Ada Komentar Pada Artikel Ini</span>';
...
var Json = eval ("("+xmlhttp.responseText+")");
if (Json.error == true){
$odb('formMessage').innerHTML = '<div class="error">'+Json.errorpesan+'</div>';
obj.disabled = false;
$odb('gambarcode').innerHTML = '<img src="http://klatenweb.com/ikutan/code_image.php?rand='+Math.random()+'" border=0>';
}else {
$odb('formMessage').innerHTML = '<div class="sukses">Thank you, Message has been sent!</div>';
$odb('frm').reset();
...
$odb('responbawah').innerHTML = '<div id="formMessage"></div><span style="padding: 30px;"><form name="frm" id="frm"><table style="padding-left: 10px;"><tr><td>Name</td><td>:</td><td><input type="text" name="user"></td></tr><tr><td>Email</td><td>:</td><td><input type="text" name="email"></td></tr><tr><td>Comment Title</td><td>:</td><td><input type="text" name="judul"></td></tr><tr><td>Comment</td><td>:</td><td><textarea name="konten" rows=4 cols=40></textarea></td></tr><tr><td>Security Code</td><td>:</td><td><span id="gambarcode"><img src="http://klatenweb.com/ikutan/code_image.php?rand='+Math.random()+'" border=0></span></td></tr><tr><td>Type Code</td><td>:</td><td><input type="text" name="codex" size=7></td></tr><tr><td></td><td></td><td><input type="button" value="Kirim Masukan" onclick="komentar.formkomentar_click('+id+',this)" id="tomboltekanvalueid"></td></tr></table></form></span>';	
...
$odb=function(e){return document.getElementById(e);};
$odb('header_ajax').innerHTML = '<br/><br/><h4 style="margin-bottom:0px;">Komentar Pengunjung</h4>';
