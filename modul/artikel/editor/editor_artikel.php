...
$query = $koneksi_db->sql_query ("SELECT * FROM `artikel` WHERE publikasi='0' $SORT_SQL LIMIT $offset, $limit");
...
$query = $koneksi_db->sql_query ("SELECT * FROM `artikel` $query_add AND publikasi='1' $SORT_SQL LIMIT  ORDER By `id` DESC $offset, $limit");
