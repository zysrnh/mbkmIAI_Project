...
<iframe src="modul/shoutbox/shoutbox.php" width="100%" height="150" frameborder="0" marginwidth="0" name="shout" marginheight="0">
...
document.getElementById('shoutboxcaptcha').innerHTML = '<img src="ikutan/code_image.php?rand='+Math.random()+'" alt="Case Sensitive"/>';	
}
function cleartext() {
...
function makerequest_shout(serverPage, objID) {
	document.getElementById(objID).innerHTML = '<img src="gambar/indicator.gif" align="absmiddle" alt=""/> Loading Data..';
...
<div id="id_shoutbox">
&raquo; <a href="javascript:makerequest_shout('modul/shoutbox/shoutform.php','id_shoutbox');">Isi Shoutbox</a>
</div>
shout;
