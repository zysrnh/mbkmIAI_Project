...
<center>Bukti Pendaftaran</center><br/>
</td>
</tr>
</tbody></table>
";
...
<br/>
Silahkan Upload berkas persyaratan sbb di bawah ini setelah anda dinyatakan LULUS :<br/>
<ul>';
...
echo  '</ul>
Upload berkas paling lambat pada '.datetimess($berkas).'<br/>
Informasi tambahan : Pelaksanaan USM pada '.datetimess($usm).'
