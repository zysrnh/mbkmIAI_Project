<div><div><h1>Pengaturan Polling</h6>
<?php
...
$admin .= "<div class=\"border\"><a href='admin.php?pilih=polling&amp;modul=yes'>Home</a> | <a href='admin.php?pilih=polling&amp;modul=yes&amp;aksi=add'>Tambah Jajak pendapat</a></div>";
...
<div align='left'>Silakan pilih Polling yang akan diPublikasi:";
    ...
    <td width='14%' align='center'>Actions</td>
			...
			{   
				...
				$CREATED = $data['created'];
					...
					$IMG_P = "<a class=\"image\" href='admin.php?pilih=polling&amp;modul=yes&amp;aksi=type&amp;pid=$PID&amp;types=chart'><img src='images/ya.png' border='0' alt='edit menjadi Chart' /></a>";	
    ...
    <td width='25%' align='center'>$CREATED</td>
    <td width='5%' align='center'><a class=\"image\" href='admin.php?pilih=polling&amp;modul=yes&amp;aksi=public&amp;pid=$PID&amp;public=$PUBLIC'><img src='images/$PUBLIC.png' border='0' alt='public' /></a></td>
        <td width='14%' align='center'><a class=\"image\" href=\"javascript:hapus('modul/polling/polling_delete.php?id=$PID','rowbody','pid_$PID');\"><img src='images/delete_button.gif' border='0' alt='delete Polling' /></a> <a class=\"image\" href='admin.php?pilih=polling&amp;modul=yes&amp;aksi=edit&amp;pid=$PID&amp;proses=1'><img src='images/edit.gif' border='0' alt='Edit Polling' /></a> </td>
...
$admin.= "<form method='post' action='admin.php?pilih=polling&amp;modul=yes&amp;aksi=add'>add colom<input type='text' name='jml_' value='$jml_' size='3' />&nbsp;&nbsp;<input type='submit' name='jumlahkotak' value='add' /></form></td></tr></table>";
