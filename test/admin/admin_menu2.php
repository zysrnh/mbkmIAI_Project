...
$admin .='<a href="admin.php?pilih=admin_menu2"><b>Home</b></a> | <a href="admin.php?pilih=admin_menu2&amp;aksi=addsub"><b>Buat Sub Menu Baru</b></a>';
...
$admin .='
	<tr>
	<td><b>'.$no.'</b></td>
	<td><a href="'.$data['url'].'"><b>'.$data['menu2'].'</b></a></td>
	<td>'.$ordering_up.'  '.$ordering_down.'</td>
	<td>'.$published.'</td>
	<td></td>
	<td><a href="admin.php?pilih=admin_menu2&amp;aksi=edit&amp;id='.$data[0].'">Edit</a></td>
	</tr>';
...
$admin .='
	<tr>
	<td></td>
	<td><a href="'.$subdata['url'].'">'.$subdata['menu2'].'</a></td>
	<td>'.$ordering_up.'  '.$ordering_down.'</td>
	<td>'.$spublished.'</td>
	<td><a href="admin.php?pilih=admin_menu2&amp;aksi=delsub&amp;id='.$subdata['id'].'" onclick="return confirm(\'Apakah Anda Yakin Ingin Menghapus Data Ini ?\')"><img border="0" src="images/delete_button.gif" width="22" height="15" alt="del" /></td>
	<td><a href="admin.php?pilih=admin_menu2&amp;aksi=editsub&amp;id='.$subdata[0].'">Edit</a></td>
	</tr>';
$i++;		
}		
}
