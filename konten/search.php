...
$_META['keywords'] = $urlkontenxc;
	...
	$tengah .='<h3 class="garis">'.ucwords($query).'</h3>   ';
	...
	$gambar = $data['gambar'];
		...
		<div class="" style="margin-bottom:20px;">
											...
											<h5>   <p style="margin-left:20px;margin-bottom:6px;"><a href="artikel/'.$data[0].'/'.$url.'.html" title="'.$data[1].'">'.$data[1].'</a></p></h5>
										
											<p style="margin-left:20px;"><i class="fa fa-calendar"></i> '.datetimess($data['tgl']).'<br/>'.limitTXT(strip_tags($data['konten']),180).'</p>
