...
/**
 * diupgrade ke php 7 dan MySQLi oleh : M. Subadar Hasyim  - subadarhasyim@yahoo.com  - +6281336667780
 * 				http://www.subadar.web.id
*/
		...
		function resize($desired_width, $desired_height, $mode="-"){
			...
			if( $this->use_gd2 ){
				if( function_exists("imagecreatetruecolor")){
					...
					//fill with white
					$ImgWhite = imagecolorallocate($this->image_resized, 255, 255, 255) or $this->error($ERR["GD2_NOT_CREATED"]);
					imagefill($this->image_resized, 0, 0, $ImgWhite) or $this->error($ERR["GD2_NOT_CREATED"]);
					//imagecolortransparent($this->image_resized, $ImgWhite) or $this->error($ERR["GD2_NOT_CREATED"]);
...
/*
$im = new hft_image ('953447-12312424022005@LOGO.GIF');
$im -> set_parameters(85);
$im -> resize(80, 80, 0);
$im -> imagecreatefromfile('953447-12312424022005@LOGO.GIF');
$im -> output_resized('lgo.jpg');
*/
?>